...
if __name__ == "__main__":
    ...
    path = "/home/ning/toy_task/run_experiments/results/eval/CNPDistractor/2021-09-28_13-26-43_distractor_datasize_None_max_maxmse_[]_seed_2578"
    filename = f"{path}/loss_vs_ctx_num.png"
    val_losses = np.loadtxt(f"{path}/val_losses.txt")
    test_losses = np.loadtxt(f"{path}/test_losses.txt")
    val_std = val_losses[:, 2]
    val_losses = val_losses[:, 1]
    test_std = test_losses[:, 2]
    ...
    plt.plot(index, val_losses, label=r'IC_Max$_{CL}$')
    plt.fill_between(index, val_losses - val_std, val_losses + val_std, alpha=0.1)

    plt.plot(index, test_losses, label='CC_Max$_{CL}$')
    plt.fill_between(index, test_losses - test_std, test_losses + test_std, alpha=0.1)

    path = "/home/gna7abt/toy_task/run_experiments/results/eval/CNPDistractor/2021-09-30_13-31-22_distractor_datasize_None_max_maxmse_[]_seed_2578"
    val_losses = np.loadtxt(f"{path}/val_losses.txt")
    test_losses = np.loadtxt(f"{path}/test_losses.txt")
    val_std = val_losses[:, 2]
    val_losses = val_losses[:, 1]
    ...
    plt.plot(index, val_losses, '--', label=r'IC_Max')
    plt.fill_between(index, val_losses - val_std, val_losses + val_std, alpha=0.1)

    plt.plot(index, test_losses, '--', label='CC_Max')
    plt.fill_between(index, test_losses - test_std, test_losses + test_std, alpha=0.1)
